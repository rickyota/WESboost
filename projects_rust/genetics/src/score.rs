...
use crate::{FillMissingScore, Wgts};
use rayon::prelude::*;
use std::fs::File;
            ...
            match wgt.wgt().model().coef() {
                ...
                Coef::Score3((s0, s1, s2)) => {
                    let sm = match missing_score {
                        ...
                        Some(FillMissingScore::Mean) | Some(FillMissingScore::Ref) | None => {
                            f64::NAN
                        }
                    };
        ...
        WgtKind::SnvInteraction(snv_inter_wgt) => {
            ...
            match wgt.wgt().model().coef() {
                Coef::LinearConstInteraction((const_ti, alpha_ti)) => {
                    match missing_score {
                        Some(FillMissingScore::Mode) | Some(FillMissingScore::Mean) => {
                        ...
                        Some(FillMissingScore::Ref) | None => {
