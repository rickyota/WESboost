...
use genetics::{alloc, dataset_file::DatasetFile, Dataset, GenotFiles};
...
fn setup_vars(
    ...
    let mut dfile = DatasetFile::new(
        GenotFiles::new_plink1(vec![fin.to_path_buf()]),
        None,
        None,
        None,
    ...
    let dataset: Dataset =
        Dataset::new_datasetfile_training(&dfile, false, None, None, None, false, None, None);
