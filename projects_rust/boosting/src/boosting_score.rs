...
use genetics::{textfile, Dataset, FillMissingGroup};
pub use run_scores::*;
use std::path::Path;
...
pub fn run_boosting_score_para_best(
    ...
    let mut wgts = WgtBoosts::new_from_file(&file_wgt, dfile.group_snv_buf());
...
pub fn run_boosting_score_para(
    ...
    // if missing_group is None, missing_score is applied to group
    boosting_score(
        dout_score,
        &iterations,
        &wgts,
